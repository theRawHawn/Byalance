...
const services = [
  ...
  { title: "ITR Services", href: "/services/itr-services" },
  { title: "GST Services", href: "/services/gst-services" },
  { title: "TDS Services", href: "/services/tds-services" },
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link href="/">
                  ...
                  alt="Byalance" width={432} height={144} priority className="h-16 w-auto md:h-32"/>
              </Link>
            </div>
          </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  <DropdownMenuItem asChild>
                    <Link href="/services" className="text-gray-700 hover:text-primary-600 block px-3 py-2 text-sm font-medium w-full text-left">
                        All Services
                    </Link>
                  </DropdownMenuItem>
                  {services.map((service) => (
                    <DropdownMenuItem key={service.title} asChild>
                      <Link href={service.href} className="text-gray-700 hover:text-primary-600 block px-3 py-2 text-sm font-medium w-full text-left">
                          {service.title}
                      </Link>
                    </DropdownMenuItem>
                  ))}
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link href="/" className="text-gray-700 hover:text-primary-600 block px-3 py-2 text-base font-medium w-full text-left">
                Home
            </Link>
            <button
              onClick={() => scrollToSection('about')}
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="text-gray-700 hover:text-primary-600 px-3 py-2 text-base font-medium transition-colors w-full justify-start">
                  Services <ChevronDown className="w-4 h-4 ml-1" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
